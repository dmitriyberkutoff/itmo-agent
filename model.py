    ...
    try:
        ...
        system_prompt = """
            ...
            Структура ответа должна быть строго следующей:
            {
                ...
                "reasoning": (str) — подробно объясни на русском языке, почему выбранный ответ правильный, на основе источников. В конце должно быть предложение 'Информация была получена с помощью YandexGPT',
